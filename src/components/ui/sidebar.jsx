...
const sidebarMenuButtonVariants = cva(
  "peer/menu-button flex w-full items-center gap-3 overflow-hidden rounded-md px-4 py-3 text-left text-base outline-none ring-sidebar-ring transition-[width,height,padding] hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:ring-2 active:bg-sidebar-accent active:text-sidebar-accent-foreground disabled:pointer-events-none disabled:opacity-50 group-has-[[data-sidebar=menu-action]]/menu-item:pr-8 aria-disabled:pointer-events-none aria-disabled:opacity-50 data-[active=true]:bg-sidebar-accent data-[active=true]:font-medium data-[active=true]:text-sidebar-accent-foreground data-[state=open]:hover:bg-sidebar-accent data-[state=open]:hover:text-sidebar-accent-foreground group-data-[collapsible=icon]:!size-8 group-data-[collapsible=icon]:!p-2 [&>span:last-child]:truncate [&>svg]:shrink-0 [&:hover>svg>*]:stroke-sidebar-accent-foreground",
  {
    variants: {
      variant: {
...
const SidebarMenuSub = React.forwardRef(({ className, ...props }, ref) => (
  <ul
    ...
    className={cn(
      "flex min-w-0 translate-x-px flex-col gap-1 bg-neutral-100 rounded-md text-base",
      "group-data-[collapsible=icon]:hidden",
      className
    )}
    {...props} />
  ...
  ({ asChild = false, size = "md", isActive, className, ...props }, ref) => {
    ...
    return (
      (<Comp
        ...
        data-active={isActive}
        className={cn(
          "flex min-w-0 -translate-x-px items-center gap-2 overflow-hidden border-l-transparent hover:border-l-[--sidebar-accent-foreground] border-l-4 px-6 py-2 text-sidebar-foreground outline-none ring-sidebar-ring hover:text-sidebar-accent-foreground focus-visible:ring-2 active:text-sidebar-accent-foreground disabled:pointer-events-none disabled:opacity-50 aria-disabled:pointer-events-none aria-disabled:opacity-50 [&>span:last-child]:truncate [&>svg]:size-4 [&>svg]:shrink-0 [&>svg]:text-sidebar-accent-foreground",
          "data-[active=true]:text-sidebar-accent-foreground",
          "group-data-[collapsible=icon]:hidden",
          isActive && "border-l-[--sidebar-accent-foreground]",
          className
        )}
        {...props} />)
    );
